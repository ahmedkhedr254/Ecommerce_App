...
import 'package:ecommerce/UI/pages/WebViewPage.dart';
import 'package:ecommerce/data/model/Laptop.dart';
import 'package:flutter/material.dart';

class ViewLaptop extends StatelessWidget {
  final Laptop myLaptop;

  ViewLaptop(this.myLaptop);
  ...
  Widget build(BuildContext context) {
    String imagePath = "http://10.0.2.2:8000/" + myLaptop.image;
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: (){
            Navigator.push(context,MaterialPageRoute(builder: (context){
              return WebViewExample(myLaptop.price.toString());
            }));
          },
        ),
        body: Column(
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(myLaptop.price.toString()+"\$",style: TextStyle(color: Colors.red,fontSize: 25 ,fontWeight: FontWeight.bold),),
