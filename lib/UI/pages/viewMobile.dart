...
class ViewMobile extends StatelessWidget {
  final Mobile myMobile;

  ViewMobile(this.myMobile);
  ...
  Widget build(BuildContext context) {
    String imagePath = "http://10.0.2.2:8000/" + myMobile.image;
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: (){
            Navigator.push(context,MaterialPageRoute(builder: (context){
              var myLaptop;
              return WebViewExample(myMobile.price.toString());
            }));
          },
        ),
        body: Column(
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text('Dell Inspiron 3593',style: TextStyle(color:Colors.lightBlue,fontSize: 28,fontWeight: FontWeight.bold),),
                SizedBox(width: width*20/100,),
                Text(myMobile.price.toString()+"\$",style: TextStyle(color: Colors.red,fontSize: 25 ,fontWeight: FontWeight.bold),),
            ...
            Padding(padding: EdgeInsets.only(left: width*2/100),child: Text('Description',style: TextStyle(color: Colors.lightBlue,fontSize: 28),),),
            ...
            Padding(padding: EdgeInsets.only(left: width*2/100),child: Text('Product information',style: TextStyle(color: Colors.lightBlue,fontSize: 28),),),
            Container(
